...
from storage.models.base import Base, SoftDeleteMixin


class ProcedureModel(Base, SoftDeleteMixin):
    __tablename__ = 'procedures'

    procedure_id = Column(RAW(16), primary_key=True, default=lambda: uuid.uuid4().bytes)
...
class ProcedureUsageModel(Base):
    ...
    material_id = Column(RAW(16), ForeignKey('materials.material_id'), primary_key=True)
